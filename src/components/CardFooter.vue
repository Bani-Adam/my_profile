     ...
     <div>
        ...
        <div class="text-center my-4 dark:text-white flex items-center justify-center">
            <a href="https://www.ut.ac.id" target="_blank"
                class="text-white py-1 px-2 ms-2 rounded-md bg-blue-600">My University</a>
        </div>
        <div class="text-center">
            <a href="https://wa.me/6285709160075" target="_blank"
                class="m-1 p-1 text-gray-600 text-2xl hover:text-blue-600 dark:text-gray-400"><font-awesome-icon
                    icon="fa-brands fa-whatsapp" /></a>
            ...
            <a href="mailto:adambani707@gmail.com"
                class="m-1 p-1 text-gray-600 text-2xl hover:text-blue-600 dark:text-gray-400"> <font-awesome-icon
